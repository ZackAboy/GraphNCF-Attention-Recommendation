...
parser = argparse.ArgumentParser(description="Run GraphNCF-A model")
...
parser.add_argument('--num_heads', type=int, default=4, help='Number of attention heads for multi-head attention')
